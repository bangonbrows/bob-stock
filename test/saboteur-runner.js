...
const MUTATIONS = [
  ...
  { id: 'S-275', file: 'sync.js',
    find: "            this._pricingFresh = false;   // OS-W42-AUDIT R2 (Codex C1): the heartbeat DEMOTION is a leadership loss — the demoted tab stops pulling, so its freshness fact would otherwise grow stale forever",
  ...
  { id: 'S-275b', sentinel: 'S-275', file: 'sync.js',
    find: "          this._pricingFresh = false;   // OS-W42-AUDIT R2 (Codex C1): standing down = a leadership loss — the pull loop is leader-only, a freshness fact must not outlive it",
  ...
  { id: 'S-275c', sentinel: 'S-275', file: 'sync.js',
    find: "              this._pricingFresh = false;   // OS-W42-AUDIT R3 (Codex C1): LOSING the election tiebreak is a leadership loss too — a pre-election observation must not outlive it",
  ...
  { id: 'S-275d', sentinel: 'S-275', file: 'sync.js',
    find: "        if (!this._isLeader) this._pricingFresh = false;   // OS-W42-AUDIT R3 (sibling of Codex C1, found by inventory): a claim ABANDONED to another leader's mid-claim heartbeat is a leadership loss the heartbeat branch never invalidates (it only runs on leaders)",
  ...
  { id: 'S-275e', sentinel: 'S-275', file: 'sync.js',
    find: "    this._pricingFresh = false;   // OS-W42-AUDIT R3 (sibling of Codex C1, found by inventory): a stopped sync can observe nothing — no freshness fact survives teardown",
  ...
  { id: 'S-275f', sentinel: 'S-275', file: 'sync.js',
    find: "    this._pricingFresh = false;   // OS-W42-AUDIT pre-R4 (the family's 401 sibling): an auth-paused device stops pulling — no freshness fact survives the pause",
