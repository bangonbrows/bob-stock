...
const SUDO_PURPOSES = ['publish', 'archive', 'user-admin', 'backup', 'approve', 'resolve', 'delivery', 'adjustment', 'cancel', 'access-policy', 'topology-change', 'correction'];  // AA-W2: +cancel, +access-policy; OS-W2: +topology-change (org wizard writes); C2 N8: +correction (the correction-approval route's triple gate — client prompt-map entry rides the next client wave)
