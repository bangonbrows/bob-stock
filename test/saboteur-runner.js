...
const MUTATIONS = [
  ...
  { id: 'S-278b', sentinel: 'S-278', file: 'phase2.js',
    find: "        if (it && it.sellAtSupply != null && it.discAtSupply != null) { x.sellAtSupply = it.sellAtSupply; x.discAtSupply = it.discAtSupply; x.pricingVersion = it.pricingVersion != null ? it.pricingVersion : 0; x.catalogueVersion = it.catalogueVersion != null ? it.catalogueVersion : 0; }",
