...
const MUTATIONS = [
  ...
  { id: 'S-277', file: 'sync.js',
    find: "    if (!has(sellRaw) || !has(discRaw)) return null;                    // one without the other = malformed",
    repl: "    if (!has(sellRaw) || !has(discRaw)) return { absent: true };   /* sabotaged: half-stamps pass as legacy */",
  ...
  { id: 'S-278b', sentinel: 'S-278', file: 'phase2.js',
    find: "        if (it && it.sellAtSupply != null && it.discAtSupply != null) { x.sellAtSupply = it.sellAtSupply; x.discAtSupply = it.discAtSupply; }",
  ...
  { id: 'S-280', file: 'records.js',
    find: "      if (l.sellAtSupply != null && l.discAtSupply != null) e.stamps.add(l.sellAtSupply + '|' + l.discAtSupply + '|' + (l.basis || ''));",
  ...
  { id: 'S-281', file: 'index.html',
    find: "          if (_it && _it.sellAtSupply != null && _it.discAtSupply != null) { sell = _it.sellAtSupply; prodDisc = _it.discAtSupply; rateSource = 'transfer-stamped'; _stamped = true; }",
    repl: "          /* sabotaged: no item-stamp valuation tier */",
