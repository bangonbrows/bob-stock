...
window.renderResolveFlags = function(transferId) {
  ...
  const flagged = (transfer.items || []).filter(i => i.flagged || (i.sentQty !== undefined && i.receivedQty !== undefined && i.sentQty !== i.receivedQty));
    ...
    ${flagged.map(i => {
      ...
      return `<div class="flag-row">
        ...
        <div class="flag-actions">
          <button class="btn-accept${fa.action === 'accept' ? ' active-action' : ''}"
            onclick="TransferUI.setFlagAction('${transferId}','${i.productId}','accept')">Accept As-Is</button>
